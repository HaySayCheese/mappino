export class FiltersService {
    constructor($rootScope, $timeout, $location, realtyTypesService) {
    ...
    update(filter_object_name, filters_object) {
    ...
    createFiltersForPanel(panel_color) {
        var self = this,
    ...
    createFormattedObjectForLoadMarkers() {
    ...
    createFormattedViewportForLoadMarkers() {
