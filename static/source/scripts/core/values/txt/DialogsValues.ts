    ...
    export class DialogsValues {
        static get Default(): any {
            return {
                ...
                'USER_EMAIL_IS_EMPTY': {
                    TITLE:      'Не указан адресс електронной почты',
                    BODY:       'Для того чтобы отправить запрос в поддержку  Mappino укажите адресс електронной почты.',
                    ARIA_LABEL: 'Для того чтобы отправить запрос в поддержку  Mappino укажите адресс електронной почты.',
                    OK_BTN:     'Да, спасибо'
                }
            };
        }
