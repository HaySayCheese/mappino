        ...
        static get Default(): any {
            return {
                ...
                'EDIT_PUBLICATION': {
                    ...
                    BODY:       'Выбранное объявление опубликовано,'
                                'для продолжения редактирования его следуют снять с публикации. \n\n'
                                'Вы уверенны, что хотите продолжить?',

                    ARIA_LABEL: 'Выбранное объявление опубликовано,'
                                'для продолжения редактирования его следуют снять с публикации. \n\n'
                                'Вы уверенны, что хотите продолжить?',

                    OK_BTN:     'Да, продолжить редактирование',
                    CANCEL_BTN: 'Отмена'
                },
                ...
                'ALL_MEANS_OF_COMMUNICATION_DISABLED': {
                    ...
                    BODY:       'Вы только что отключили все способы связи с Вами. \n'
                                'Возможно, стоит пересмотреть настройки?',

                    ARIA_LABEL: 'Вы только что отключили все способы связи с Вами. \n'
                                'Возможно, стоит пересмотреть настройки?',

                    OK_BTN:     'Да, я пересмотрю'
                }
            };
        }
    }
