...
// ####################
// mappino modules import
// ####################
/// <reference path='../../core/_all.ts' />
...
/// <reference path='controllers/PublishedPublicationController.ts' />
/// <reference path='controllers/UnpublishedPublicationController.ts' />
