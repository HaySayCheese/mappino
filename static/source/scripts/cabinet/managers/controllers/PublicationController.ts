namespace Mappino.Cabinet.Managers {
    export class PublicationController {
        ...
        constructor(private $scope: any,
            ...
            $scope.publicationTemplateUrl = '/ajax/template/cabinet/managers/publications/unpublished/' + this.publicationIds.tid + '/';
        ...
        public removePublication($event) {
            ...
            this.$mdDialog.show(confirm).then(() => {
                ...
                this.publicationsService.remove(this.publicationIds)
                    .success(response => {
                        this.$rootScope.loaders.overlay = false;
                        this.$state.go('userBriefs', { user_hid: this.$state.params['user_hid']});
                    })
                    .error(response => {
                        this.$rootScope.loaders.overlay = false;
                    })
