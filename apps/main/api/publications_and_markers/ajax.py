...
from apps.main.api.publications_and_markers.utils import parse_flats_filters, parse_houses_filters, parse_rooms_filters, \
    parse_lands_filters, parse_garages_filters, parse_offices_filters, parse_trades_filters, parse_warehouses_filters, \
    parse_businesses_filters
...
class Markers(View):
    ...
    def __markers_count_per_segment(cls, params):
        ...
        try:
            tids_panels_and_filters = cls.__parse_tids_panels_and_filters(params)
        except ValueError:
    ...
    @staticmethod
    def __parse_tids_panels_and_filters(params):
        """
        :param params: JSON object (dict in this method) with request parameters.
...
# class NearSuitedObjectsView(CustomerView):
#     class GetResponses(object):
#         @classmethod
#         def ok(cls, data):
#             return {
